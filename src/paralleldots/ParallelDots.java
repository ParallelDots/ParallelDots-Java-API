...
public class ParallelDots{
	...
	public static void main(String[] args) throws Exception {
		ParallelDots pd = new ParallelDots("wQYG4oIQrkBQsavDfzUIsIKEe4w4hIZaJy9BGlRjpMw");
		ParallelDots pd = new ParallelDots("pqo9mvej6CkAgNTWGhs0OgkhaedPLsgRBOMXsYNJWsQ");
		...
		String multilang = pd.multilang("La%20ville%20de%20Paris%20est%20tr%C3%A8s%20belle", "fr");
